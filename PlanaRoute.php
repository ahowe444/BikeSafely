...
<body>
   ...
   <!-- Navigation -->
    ...
    <div class="mySlides w3-display-container w3-center">
        ...
        <div class="w3-display-bottommiddle w3-container w3-text-black w3-padding-32 w3-hide-small">
            ...
            <p id="slide-sub1"><b>Become a safer cyclist!</b></p>
        </div>
    </div>
    <div class="mySlides w3-display-container w3-center">
        <img src="/images/squad.jpg" style="width:100%">
        <div class="w3-display-bottommiddle w3-container w3-text-black w3-padding-32 w3-hide-small">
            <h3 style = "color:rgba(255,255,255,.7)";>More enjoyable bike rides</h3>
            <p  id="slide-sub2" style = "color:rgba(255,255,255,.7)";><b>User input is available to improve bike enjoyment factor.</b></p>
        </div>
    </div>
    <div class="mySlides w3-display-container w3-center">
        <img src="/images/path.jpg" style="width:100%">
        <div class="w3-display-bottommiddle w3-container w3-text-black w3-padding-32 w3-hide-small">
            <h3 style = "color:rgba(255,255,255,.7)";>Easy route planning.</h3>
            <p id="slide-sub3" style = "color:rgba(255,255,255,.7)";><b>Maps and past routes are accessible.</b></p>
        </div>
    </div>
  ...
  <div id='saveFormDiv' class='modal'>
    <div class='modal-content'>
      ...
      <form id='saveForm' action='saveRoute.php' method = 'post' target = ''>
        Route Name: <br>
          <input id="textbar" type = 'text' name = 'routeName' placeholder ='Route Name'></input> <br>
          <input id="submit" type ='submit' name='saveSubmit' value='Submit'></input>
          <input id= 'routeDistForm' type ='hidden' name='routeDist' value=''></input>
          <input id='routeWaypts' type='hidden' name='routeWaypts' value=''></input>
      </form>
    </div>
  </div>
  <style>
