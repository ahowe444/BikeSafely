...
<body>
  ...
  <div>
     ...
     <button class='btn' onclick="setCurrentLoc()" id='currentLocation'>Starting at Current Location?</button>
  </div>
  <div>
  ...
  <div id='saveFormDiv' class='modal'>
    <div class='modal-content'>
      ...
      <form id='saveForm' action='saveRoute.php' method = 'post' target='testframe'>
        <label class='modal-label'>Route Name: </label><br>
          <input class='modal-input' type = 'text' name = 'routeName' placeholder ='Route Name'></input> <br>
          <input class ='btn-modal' type ='submit' name='saveSubmit' value='Submit'></input>
  ...
  <!-- <input id="pac-input" class="controls" type="text" placeholder="End Destination"> -->
    <div id="map" style="height:600px; margin-left: 100px; margin-right: 100px"></div>
      <div>
      ...
      function setCurrentLoc()
        {
          if(navigator.geolocation)
          {
            navigator.geolocation.getCurrentPosition(function(position) {
              ...
              document.getElementById('pac-input').value = pos;
            })
          }
        }
