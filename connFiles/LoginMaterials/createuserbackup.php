<?php
    require('../../LoginMaterials/dbcredentials.php');
    session_start();
    ...
    if (isset($_POST['email']) && isset($_POST['password'])){
        $email = $_POST['email'];
        $pass = $_POST['password'];
        $passquery = "SELECT password, name FROM cust_info WHERE email = '$email'";
            ...
            if(mysqli_num_rows($passresult)==0 && $bothfilled)
                ...
                while($row = $passresult->fetch_assoc())
                {
                    ...
                    if (strcmp($userpass, $pass)== 0) {
                       ...
                       header("Location: ../business-2/MainPage.php");
                    }   
                    else{
                        if($bothfilled){
...
<body id='body'; background="/images/create user.jpg" >
    ...
    ?>
        ...
        <form action="" method="POST">
            ...
            <a class="btn" href="../Home Page/business-2/login.php">Login</a>
        </form>
    </div>
</body>
</html>